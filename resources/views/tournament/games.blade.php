		...
		<div class="col-sm-12 ">
			<div class="category-filter pb-5 " width="50%">
              ...
              {{--<div class="dropdown-menu">--}}
                ...
                {{----}}
              {{--</div>--}}
    			<button class="btn btn-outline-danger category-button mr-3" data-filter="portraits">{{ $platform->name }}</button>
    			<button class="btn btn-outline-danger category-button mr-3" data-filter="landscapes">{{ $category->name }}</button>
			</div>
		</div>
	</div>
<br>
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-4 col-lg-3 filter portraits mb-5">
          <a href="{{ url("Tournament1") }}">
            <img src="{{ asset("img/client/{$game->image}") }}" width ="250px" height ="250px" class="img-fluid" title="{{ $game->name }}">
          </a>
		</div>
        @endforeach
	</div>
...
<script src="{{ asset('category-filter.js') }}"></script>
