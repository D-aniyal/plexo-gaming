        ...
        <div id="signup" class="py-3">
            ...
            <div class="loginBox">
                ...
                <form method="POST" action="{{ url('signup') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="first_name" placeholder="First Name" id="name" type="text"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input name="email" placeholder="Enter Email" id="email" type="email"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Date of Birth" id="dob"
                                       ...
                                       value="{{ old('dob') }}" required autofocus placeholder="Date of Birth"
                                       type="date"/>
                    ...
                    <a href="{{ url('login') }}">Already have an account? <u>LOGIN</u></a>
                </form>
            </div>
