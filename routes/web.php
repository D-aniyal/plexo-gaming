...
Route::get('tournament/platform/{slug}', 'TournamentController@set_platform');
Route::get('tournament/category', 'TournamentController@category');
Route::get('tournament/category/{slug}', 'TournamentController@set_category');
Route::get('tournament/games', 'TournamentController@games');
